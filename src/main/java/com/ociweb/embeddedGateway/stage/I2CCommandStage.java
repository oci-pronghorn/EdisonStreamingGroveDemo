...
//                       (byte)((Grove_LCD_RGB.RGB_ADDRESS<<1)|0), Grove_LCD_RGB.REG_BLUE,   (byte)0xF1,
                       ...
                       (byte)((Grove_LCD_RGB.RGB_ADDRESS<<1)|0), Grove_LCD_RGB.REG_GREEN,  (byte)0x77,
                       (byte)((Grove_LCD_RGB.RGB_ADDRESS<<1)|0), Grove_LCD_RGB.REG_BLUE,   (byte)0x77,
...
//                       
                      ...
                      // (byte)((Grove_LCD_RGB.LCD_ADDRESS<<1)|0), (byte)0, (byte)Grove_LCD_RGB.LCD_CLEARDISPLAY,
                       ...
                       (byte)Grove_LCD_RGB.LCD_SETCGRAMADDR | (byte)0x80, (byte)'o',
                       (byte)Grove_LCD_RGB.LCD_SETCGRAMADDR | (byte)0x80, (byte)'c',   
                       (byte)Grove_LCD_RGB.LCD_SETCGRAMADDR | (byte)0x80, (byte)'i',  
                       (byte)Grove_LCD_RGB.LCD_SETCGRAMADDR | (byte)0x80, (byte)'w',  
                       (byte)Grove_LCD_RGB.LCD_SETCGRAMADDR | (byte)0x80, (byte)'e',  
                       (byte)Grove_LCD_RGB.LCD_SETCGRAMADDR | (byte)0x80, (byte)'b',
                       (byte)Grove_LCD_RGB.LCD_SETCGRAMADDR | (byte)0x80, (byte)'.',   
                       (byte)Grove_LCD_RGB.LCD_SETCGRAMADDR | (byte)0x80, (byte)'c',  
                       (byte)Grove_LCD_RGB.LCD_SETCGRAMADDR | (byte)0x80, (byte)'o',  
                       (byte)Grove_LCD_RGB.LCD_SETCGRAMADDR | (byte)0x0,  (byte)'m',  
